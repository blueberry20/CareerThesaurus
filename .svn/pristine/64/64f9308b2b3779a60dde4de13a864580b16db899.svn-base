...
function createRecordTextInput(f, attributes) {
...
function createRecordElement(type, text, attributes) {
...
function createRecordControlContainer(control) {
    var div = document.createElement('div');
...
function createRecordLabel(field) {
