...
var addedfieldnames = new Array();

function fieldAlreadyAdded(name) {
    for (var i = 0; i < addedfieldnames.length; i++) {
        if ($.trim(addedfieldnames[i].toLowerCase()) == $.trim(name.toLowerCase())) {
            return true;
        }
    }
    return false;
