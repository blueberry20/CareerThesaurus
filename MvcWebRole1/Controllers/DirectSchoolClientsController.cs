...
{
    public class DirectSchoolClientsController : ControllerBase
    {
        //
        ...
        [HttpPost]
        public string UploadLogo(System.Web.HttpPostedFileBase Filedata, string schoolid)
        {
            try
            {
                ...
                if (img != null)
                {
                    if (img.ImageFormat == "Bitmap")
                    {
                        ...
                        PictureManager.Instance.UploadRawImage(converted, schoolid, "resources", "schoollogos");
                    }
                    else
                    {
                        PictureManager.Instance.UploadRawImage(img, schoolid, "resources", "schoollogos");
                    }
                }
                else
                {
                    ...
                    PictureManager.Instance.UploadRawImage(img2, schoolid, "resources", "schoollogos");
                }
