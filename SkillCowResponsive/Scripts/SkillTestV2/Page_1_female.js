...
function constractorQuestion_1() {
    ...
    $('.characters').append('<img class="left_1 img" id="left_1" data-tooltip="' + parameters.left_1_Tooltip + '" data-positionx="' + parameters.left_1_TooltipX + '" data-positiony="' + parameters.left_1_TooltipY + '" src="' + url + 'left_1.png" />').
                     append('<img class="right_1 img" id="right_1" data-tooltip="' + parameters.right_1_Tooltip + '" data-positionx="' + parameters.right_1_TooltipX + '" data-positiony="' + parameters.right_1_TooltipY + '" src="' + url + 'right_1.png" />');
    if (gender == 'male') {
        $('.characters').append('<img class="center_1 img" id="center_1" data-tooltip="' + parameters.center_1_Tooltip + '" data-positionx="' + parameters.center_1_TooltipX + '" data-positiony="' + parameters.center_1_TooltipY + '" src="' + url + 'center_1.png" />');
    }
}
