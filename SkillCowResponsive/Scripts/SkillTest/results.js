...
function renderData(containerid, title, params) {
    ...
    //   $('#' + containerid).append('<div><input id="searchbox" type="text" onkeyup="applyFilter($(\'#searchbox\').val());" placeholder="Keyword search"/></div>');  

    //Lesha's original code
    //var attributelinks = '';
    //for (var i = 0; i < dimensiondefinitions.length; i++) {
    //    attributelinks += '<div class="dimension ' + dimensiondefinitions[i].name + '">'; //<div class="label">' + dimensiondefinitions[i].caption + ':</div>';
    //    for (var j = 0; j < dimensiondefinitions[i].values.length; j++) {
    //        attributelinks += '<span dimension="' + dimensiondefinitions[i].name + '" onclick="toggledimension(this);">' + dimensiondefinitions[i].values[j].caption + '</span>';
    //    }
    //    attributelinks += '</div>';
    //}
    //$('#dimensionscontainer .collapsableDiv').append(attributelinks);
    ...
    $('#' + containerid).append('<div id="dimensionscontainer" class="collapsingWrapper step col-lg-3 col-md-4 col-sm-4">'+
                                    ...
                                    '<div id="traitsDiv" class="collapsableDiv row">'+
                                        '<div class="textWrapper">'+
                                            ...
                                            '<h4 class="desktop">(Select all that apply)</h4>' +
        ...
        var attributelinks = ''; 
        for (var i = 0; i < dimensiondefinitions.length; i++) {
            attributelinks += '<div class="row dimension ' + dimensiondefinitions[i].name + '">'; //<div class="label">' + dimensiondefinitions[i].caption + ':</div>';
            for (var j = 0; j < dimensiondefinitions[i].values.length; j++) {
                attributelinks += '<div class="dimensionCell col-lg-6 col-md-6 col-sm-6 col-xs-6" dimension="' + dimensiondefinitions[i].name + '" data-value="' + dimensiondefinitions[i].values[j].value + '" onclick="toggledimension(this);">' + dimensiondefinitions[i].values[j].caption + '</div>';
                //attributelinks += '<span class="tableCell" dimension="' + dimensiondefinitions[i].name + '" onclick="toggledimension(this);">' + dimensiondefinitions[i].values[j].caption + '</span>';
            }
            attributelinks += '</div>';
        }
       ...
       // setInterval(function () { $(random).removeClass('active'); }, 6000);
        ...
        var groupinglinks2 = '<div id="mainWrapper" class="step col-lg-6 col-md-5 col-sm-5 col-xs-12">' +
                                ...
                                '<div class="row extraMargin">' +
                                    ...
                                    //sort by
                                        '<div class="desktopBtn dropdown pull-right sortBtn">' +
                                        ...
                                        '</div>' +
                                     //group by dropdown
                                        '<div class="desktopBtn dropdown pull-right groupBtn">' +
                                            '<button class="dropdown-toggle" data-toggle="dropdown">Group by<span class="caret"></span></button>' +
                                            '<span class="dropdown-arrow"></span>' +
                                            '<ul class="dropdown-menu groupby">' +
                                                '<li class="activeLi"><a href="javascript:(\'\'); ">No grouping</a></li>' +
                                ...
                                '<div class="row sortedInfo">Careers displayed are sorted by <span id="sortByP">salary</span></div>' +
...
');
        ...
        $('#mainWrapper').append('<div id="columns" class="columns"></div></div></div>').append('<div class="adsenseCenter"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><h6 class="advertisement">Advertisement</h6><ins class="adsbygoogle adslot_2" style="display:block" data-ad-client="ca-pub-3486420009474810" data-ad-slot="6576327288" data-ad-format="auto"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script></div>');
        ...
        //sidebar
        $('#main').append('<div class="col-lg-3 col-md-3 col-sm-3">' +
                            '<div class="row tryMatchingDiv">' +
                                '<div><img class="matchingIcon" src="/Content/images/manhexoverlay1.png" alt="Person Icon" /></div>' +
        ...
        //3. Add Interests
        //var thingslinks = '';
        //thingslinks += '<div class="importantthings step collapsingWrapper col-lg-3 col-md-3 col-sm-3">'+
        //                    '<h2 class="desktop">Refine Matches</h2>'+
        //                    '<div id="importantThingsDiv" class="collapsableDiv col-lg-12 cl-effect-2">'+
        //                        '<div class="textWrapper">'+
        //                             '<h3>By unselecting interests that are not important to you</h3>'+
        //                             '<div class="desktop promptDiv"><div class="arrow-down"></div>'+
        //                        '</div>'+
        //                        '<div class="mobile closeIcon menuIcon">Done</div>'+
        //                        '<h4 class="mobile numberMatched">(46 Careers Matched)</h4>'+
        //                    '</div>'+
        //                    '<div id="impThingsWrapper"></div>'+
        //                    '</div>' +
        //                    //switch to match careers by interest
        //                    '<div class="col-lg-12 tryMatchingDiv">'+ 
        //                        '<div><img class="matchingIcon" src="/Content/images/hexagonPerson.png" alt="Person Icon" /></div>'+
        //                        '<p>Switch to matching careers only by interests!</p>'+
        //                        '<a href="ByInterest" class="tryMatchingBtn">Go!</a>'+
        //                    '</div>' +
        //               '</div>';
        ...
        //    $('#impThingsWrapper').append('<a href="#" style="position:relative"><span class="impThingsSpan" data-hover="' + importantthingdefinitions[i].caption + '" onclick="toggleimportantthing(this);" dimension="' + importantthingdefinitions[i].name + '" value="1">' + importantthingdefinitions[i].caption + '</span></a>');
        //}
        ...
        //var countInterestsInit = parseInt($('#impThingsWrapper .active').length);
       // $('#interestsSelected').html(parseInt($('#impThingsWrapper .active').length));
        //if (countInterests == 0) {
        //    $('#interestsSelected').hide();
        //}
        //else {
...
function renderhtml(id) {
    ...
    for (var i = 0; i < professionsFoundArray.length; i++) {
        ...
        $('#p' + id).append(htmlforitem(item.title, item.title.replace(new RegExp(filtervalue, "i"), '<span style="background-color: yellow">' + filtervalue + '</span>'), item.salary, onclick, item.akaTitle != '' ? (' (aka ' + item.akaTitle.replace(new RegExp(filtervalue, "i"), '<span style="background-color: yellow">' + filtervalue + '</span>') + ')') : '', item.code, ratedHtml));
    }
