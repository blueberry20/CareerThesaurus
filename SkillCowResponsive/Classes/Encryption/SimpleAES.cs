...
namespace SkillCowResponsive.Classes.Encryption
{
    public class SimpleAES
    {
        ...
        {
            string output = Convert.ToBase64String(Encrypt(TextValue));
        ...
        public string DecryptFromBase64String(string EncryptedString)
        {
            string output = EncryptedString.Replace("_", "/").Replace("-", "+");
            return Decrypt(Convert.FromBase64String(output));
        }
