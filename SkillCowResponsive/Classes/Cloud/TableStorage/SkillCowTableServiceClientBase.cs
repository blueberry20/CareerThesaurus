...
{
    public abstract class SkillCowTableServiceClientBase<T> where T : TableServiceEntity
    {
        ...
        protected SkillCowTableServiceClientBase(string tableName)
        {
        ...
        private void Connect()
        {
            ...
            while (trycount++ < 3)
            {
                try
                {
                    ...
                    string connectionString = "DefaultEndpointsProtocol=https; AccountName=chaindate; AccountKey=DnEefaS2C46ILdR+fM1ZDzyOuZKB+4l2Gl1AcQirLZO4Lw3VAXz9lVdQokmBCkNQJRzk+C4WPnV5mV1mPMZ/Aw==";
